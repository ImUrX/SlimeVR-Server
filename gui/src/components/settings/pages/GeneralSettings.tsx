...
import { CreateThemeModal } from '../../commons/CreateThemeModal';
import { PlusIcon } from '../../commons/icon/PlusIcon';
...
export function GeneralSettings() {
  ...
  const [themeModal, setThemeModal] = useState(true);
